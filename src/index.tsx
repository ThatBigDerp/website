...
<Layout>
    ...
    <div class="flex items-center justify-center">
        ...
        <div class="absolute w-full h-full">
          <svg id="wave" viewBox="0 0 1440 690" xmlns="http://www.w3.org/2000/svg" class="fixed w-full h-full bg-white" style="z-index: -50;">
...
<section class="text-gray-600 flex max-w-full ml-56 mx-auto body-font items-center justify-center">
  <div class="container px-5 py-24 mx-auto max-w-7x1">
    ...
    <div id="news-section" class="flex flex-wrap">
      ...
      <section class="xl:w-1/3 md:w-1/2 p-4">
        <div class="p-6 rounded-lg">
          <img class="lg:h-60 xl:h-56 md:h-64 sm:h-72 xs:h-72 h-72 rounded w-full object-cover object-center mb-6" src="https://asset.kompas.com/crops/Pk_pN6vllxXy1RshYsEv74Q1BYA=/56x0:1553x998/750x500/data/photo/2021/06/16/60c8f9d68ff4a.jpg" alt="Image Size 720x400" />
          <h3 class="tracking-widest text-indigo-500 text-xs font-medium title-font">SUBTITLE</h3>
          <h2 class="text-lg text-gray-900 font-medium title-font mb-4">Нов Сет!</h2>
          <p class="leading-relaxed text-base">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Vero aliquam corrupti </p>
        </div>
      </section>
      <section class="xl:w-1/3 md:w-1/2 p-4">
        <div class="p-6 rounded-lg">
          <img class="lg:h-60 xl:h-56 md:h-64 sm:h-72 xs:h-72 h-72 rounded w-full object-cover object-center mb-6" src="https://asset.kompas.com/crops/Pk_pN6vllxXy1RshYsEv74Q1BYA=/56x0:1553x998/750x500/data/photo/2021/06/16/60c8f9d68ff4a.jpg" alt="Image Size 720x400" />
          <h3 class="tracking-widest text-indigo-500 text-xs font-medium title-font">SUBTITLE</h3>
          <h2 class="text-lg text-gray-900 font-medium title-font mb-4">Някаква си новина!!!</h2>
          <p class="leading-relaxed text-base">quaerat dicta beatae unde doloremque, asperiores illum architecto saepe.</p>
        </div>
      </section>
      <section class="xl:w-1/3 md:w-1/2 p-4">
        <div class=" p-6 rounded-lg">
